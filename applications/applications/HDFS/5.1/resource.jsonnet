  ...
  __moduleResourceRaw(moduleName, config={})::
    ...
    local storage = {
      hdfs: {
        ...
        hdfs_data_tmp_storage: t.assembleStorageEntry(config, "hdfs_data_tmp_storage", s.StorageClass, s.DiskNormalSize, kind="tosdisk"),
        hdfs_name_data_storage: t.assembleStorageEntry(config, "hdfs_name_data_storage", s.StorageClass, s.DiskDataSize, kind="pvc"),
        hdfs_name_tmp_storage: t.assembleStorageEntry(config, "hdfs_name_tmp_storage", s.StorageClass, s.DiskNormalSize, kind="tosdisk"),
      },
      zookeeper: {
